...
def create_advanced_box(analysis_type):
	...
	if analysis_type == 'fplc':
		def show_entry_fields():
			...
			param_dict['peak_analysis'] = str(var8.get())
		...
		ttk.Label(master, text="Analyze peaks?").grid(row=7, column=0)
		var8 = tk.StringVar(master)
		var8.set("yes")
		e8 = ttk.OptionMenu(master, var8, "yes", "yes", "no")
		...
		def show_entry_fields():
			...
			param_dict['conc_unit'] = str(var10.get())
			param_dict['data_visual'] = str(var11.get())
		...
		ttk.Label(master, text="Concentration unit?").grid(row=6, column=1)
		var10 = tk.StringVar(master)
		var10.set('nM')
		e10 = ttk.OptionMenu(master, var10, 'nM', 'nM', 'uM', 'mM', '%')
		e10.grid(row=6, column=2)

		ttk.Label(master, text="Visualization?").grid(row=7, column=1)
		var11 = tk.StringVar(master)
		var11.set('Mean w. std. dev.')
		e11 = ttk.OptionMenu(master, var11, 'Mean w. std. dev.', 'Mean w. std. dev.',
							 'All data points')
		e11.grid(row=7, column=2)
		...
		def show_entry_fields():
			...
			param_dict['peak_rel_height'] = float(e12.get())
		...
		ttk.Label(master, text="Peak relative height for peak fit (0-1)").grid(row=12, column=1)
