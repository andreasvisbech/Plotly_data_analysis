...
def bar_main(df, x_id, y_id, error_id, sample_idx, plot_dict, user_input_dict, param_dict):
    ...
    if error_id in df.columns:
        ...
        plot_func(figure, graph_name, xs, ys, error_values, plot_marker, x_title, y_title, subplot_row, subplot_col, 'Bar_error', sample_idx, param_dict, color_list, color_count, user_input_dict)
        plot_func(plot_figure, graph_name, xs, ys, error_values, plot_marker, x_title, y_title, subplot_row, subplot_col, 'Bar_error', sample_idx, param_dict, color_list, color_count, user_input_dict)
        
    else:
        plot_func(figure, graph_name, xs, ys, 'N/A', plot_marker, x_title, y_title, subplot_row, subplot_col, 'Bar', sample_idx, param_dict, color_list, color_count, user_input_dict)
        plot_func(plot_figure, graph_name, xs, ys, 'N/A', plot_marker, x_title, y_title, subplot_row, subplot_col, 'Bar', sample_idx, param_dict, color_list, color_count, user_input_dict)