...
def akta_main_func(df, xs, ys, sample_idx, x_id, y_id, param_dict, master_dict, user_input_dict, plot_dict):
	...
	if str(df['AKTA_fraction'][sample_idx]).count(';') == 1:
		...
		plot_func(figure, graph_name + '_fraction', xsys_slice[x_id], xsys_slice[y_id], 'N/A', 'lines', x_title,
				  y_title, subplot_row, subplot_col, 'AKTA_fraction', sample_idx, param_dict, color_list,
				  color_count, user_input_dict, master_dict)
		plot_func(plot_figure, graph_name + '_fraction', xsys_slice[x_id], xsys_slice[y_id], 'N/A', 'lines', x_title,
				  y_title, subplot_row, subplot_col, 'AKTA_fraction', sample_idx, param_dict, color_list,
				  color_count, user_input_dict, master_dict)
