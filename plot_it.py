...
fig = make_subplots(rows=user_input_dict['subplot_row_count'], cols=user_input_dict['subplot_col_count'], vertical_spacing=0.07, horizontal_spacing=0.07)
plot_fig = make_subplots(rows=user_input_dict['subplot_row_count'], cols=user_input_dict['subplot_col_count'], vertical_spacing=0.07, horizontal_spacing=0.07)
...
if args.plot_type in ['Scatter', 'scatter']:
    ...
    for i in range(len(ID_list)):
        ...
        # Check if the data should just be plotted or if user is trying to fit. This is checked by seing if user has inputed fitting interval and fitting model
